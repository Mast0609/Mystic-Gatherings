package net.mcreator.mysticgatherings;
...
@Mod("mystic_gatherings")
public class MysticGatheringsMod {
	public static final Logger LOGGER = LogManager.getLogger(MysticGatheringsMod.class);
	public static final String MODID = "mystic_gatherings";

	public MysticGatheringsMod(IEventBus modEventBus) {
