...
public class T1FuelCheckProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (getBlockNBTNumber(world, BlockPos.containing(x, y, z), "activationTimer") <= 0) {
			if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof MysticGatheringsModMenus.MenuAccessor _menu1 ? _menu1.getSlots().get(5).getItem() : ItemStack.EMPTY).getItem() == MysticGatheringsModItems.RAW_MYSTIA_GEM
					.get()) {
