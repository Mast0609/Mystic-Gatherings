		...
		if (getBlockNBTNumber(world, BlockPos.containing(x, y, z), "activationTimer") > 0) {
			if (RitualCircleT2ConditionsProcedure.execute(entity)) {
				if (entity instanceof Player _player && _player.containerMenu instanceof MysticGatheringsModMenus.MenuAccessor _menu) {
					ItemStack _setstack1 = new ItemStack(MysticGatheringsModBlocks.TIER_2_RITUAL_CIRCLE.get()).copy();
				...
				if (entity instanceof Player _player && _player.containerMenu instanceof MysticGatheringsModMenus.MenuAccessor _menu) {
					ItemStack _setstack2 = new ItemStack(MysticGatheringsModItems.AGRIUM_INGOT.get()).copy();
				...
				if (entity instanceof Player _player && _player.containerMenu instanceof MysticGatheringsModMenus.MenuAccessor _menu) {
					ItemStack _setstack3 = new ItemStack(MysticGatheringsModItems.BRADISH_INGOT.get()).copy();
				...
				if (entity instanceof Player _player && _player.containerMenu instanceof MysticGatheringsModMenus.MenuAccessor _menu) {
					ItemStack _setstack4 = new ItemStack(MysticGatheringsModItems.VERITA_INGOT.get()).copy();
				...
				if (entity instanceof Player _player && _player.containerMenu instanceof MysticGatheringsModMenus.MenuAccessor _menu) {
					ItemStack _setstack5 = new ItemStack(MysticGatheringsModItems.CALDON_INGOT.get()).copy();
				...
				if (entity instanceof Player _player && _player.containerMenu instanceof MysticGatheringsModMenus.MenuAccessor _menu) {
					ItemStack _setstack6 = new ItemStack(MysticGatheringsModItems.ABARASH_INGOT.get()).copy();
					_setstack6.setCount(1);
					_menu.getSlots().get((int) outputSlot).set(_setstack6);
					_player.containerMenu.broadcastChanges();
				}
			} else {
				if (entity instanceof Player _player && _player.containerMenu instanceof MysticGatheringsModMenus.MenuAccessor _menu) {
