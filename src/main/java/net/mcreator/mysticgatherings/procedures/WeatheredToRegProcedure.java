...
public class WeatheredToRegProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof AxeItem
				&& (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == MysticGatheringsModBlocks.WEATHERED_DREAL_BLOCK.get()) {
			{
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.HONEYCOMB
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = MysticGatheringsModBlocks.WAXED_WEATHERED_DREAL_BLOCK.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Property<?> _propertyOld : _bso.getProperties()) {
					Property _propertyNew = _bs.getBlock().getStateDefinition().getProperty(_propertyOld.getName());
					if (_propertyNew != null && _bs.getValue(_propertyNew) != null)
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof AxeItem
				&& (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == MysticGatheringsModBlocks.WAXED_WEATHERED_DREAL_BLOCK.get()) {
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
